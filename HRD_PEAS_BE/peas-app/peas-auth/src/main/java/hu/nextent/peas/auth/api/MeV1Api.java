...
public interface MeV1Api {

    Logger log = LoggerFactory.getLogger(MeV1Api.class);
    ...
    default ResponseEntity<UserModel> currentUser() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default MeV1Api interface so no example is generated");
        }
