...
public interface LogoutV1Api {

    Logger log = LoggerFactory.getLogger(LogoutV1Api.class);
    ...
    default ResponseEntity<Void> logout() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default LogoutV1Api interface so no example is generated");
        }
